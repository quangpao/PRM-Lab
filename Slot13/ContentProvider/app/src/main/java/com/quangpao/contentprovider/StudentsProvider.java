package com.quangpao.contentprovider;
...
public class StudentsProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.quangpao.contentprovider.StudentsProvider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case STUDENTS:
                return "vnd.android.cursor.dir/vnd.quangpao.contentprovider.students";
            case STUDENT_ID:
                return "vnd.android.cursor.item/vnd.quangpao.contentprovider.students";
            default:
